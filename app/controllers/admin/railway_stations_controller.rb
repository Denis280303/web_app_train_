  ...
  def create
    ...
    respond_to do |format|
      if @railway_station.save
        format.html { redirect_to admin_railway_station_url(@railway_station), notice: 'Railway station was created.' }
  ...
  def update
    respond_to do |format|
      if @railway_station.update(railway_station_params)
        format.html { redirect_to admin_railway_station_url(@railway_station), notice: 'Railway station was updated.' }
      else
